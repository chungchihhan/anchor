...
export function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 transition-all" onClick={onClose}>
            <div className="bg-black/30 backdrop-blur-xl border border-white/10 rounded-xl w-full max-w-2xl shadow-2xl flex flex-col max-h-[85vh] animate-in fade-in zoom-in duration-150 overflow-hidden ring-1 ring-white/5" onClick={e => e.stopPropagation()}>
                {/* Header */}
                ...
                <div className="flex-1 overflow-y-auto p-6 custom-scrollbar bg-black/40">
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-xs font-semibold text-white/60 uppercase tracking-wider">General</h3>
                            <div className="space-y-4">
                        ...
                        {/* Appearance Settings */}
                        <div className="space-y-4">
                            <h3 className="text-xs font-semibold text-white/60 uppercase tracking-wider">Display Mode</h3>
