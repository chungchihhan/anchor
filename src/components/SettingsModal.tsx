...
export function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
  ...
  return (
    ...
    >
      <div
        className="bg-black/95 border border-white/10 rounded-xl w-full max-w-2xl shadow-2xl flex flex-col max-h-[85vh] animate-in fade-in zoom-in duration-150 overflow-hidden ring-1 ring-white/5"
